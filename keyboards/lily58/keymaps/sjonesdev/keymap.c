...
// #define HID_GUI_AC_DESKTOP_SHOW_ALL_WINDOWS 0x029f
// #define MSNCTRL 0xc1 // mission control on mac

// page desktop left/right on mac
#define PGL QK_USER_0
#define PGR QK_USER_1
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV, KC_EXLM,  PGL,     KC_MCTL, PGR,     KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD,
